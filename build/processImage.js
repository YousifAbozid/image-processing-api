...
var processImage = function (filename, width, height) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                image = path_1.default.join(__dirname, '../assets/full', "".concat(filename, ".jpg"));
                thumbFolder = path_1.default.join(__dirname, '../assets/thumb');
                imageOutput = path_1.default.join(__dirname, '../assets/thumb', filename) +
                    "-".concat(width, "-").concat(height, ".jpg");
                if (!!fs_2.default.existsSync(thumbFolder)) return [3 /*break*/, 2];
            ...
            case 2:
                ...
                return [4 /*yield*/, (0, sharp_1.default)(image).resize(width, height).toFile(imageOutput)];
            case 3:
                // Resize the image and return the resized image
                _a.sent();
